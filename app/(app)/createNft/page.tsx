        ...
        <div className="w-full flex justify-center">
            <div className="flex gap-8 py-10 tablet:py-20 desktop:py-20" style={{ width: '1140px' }}>
                <div className="flex flex-col w-full tablet:w-4/6 desktop:w-4/6">
                    <Text className="text-body-32 tablet:text-body-40 desktop:text-body font-semibold mb-6 tablet:mb-10 desktop:mb-10">Create New Item</Text>
                            ...
                            <div>
                                ...
                                <div className="flex">
                                    ...
                                    <div className="relative w-full">
                                        <input type="text" id="search-dropdown" className="bg-surface-soft outline-none placeholder:text-tertiary text-primary focus-visible:ring-[0.5px] focus:ring-primary w-full border-none text-body-14 rounded-tr-2xl rounded-br-2xl p-3 h-12" placeholder="99" />
                                    </div>
                                </div>
                            </div>
                            {/* Minimum bid */}
