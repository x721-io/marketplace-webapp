            ...
            <div className="flex flex-col gap-4 desktop:gap-8 py-4 tablet:py-8 desktop:py-10 ">
                ...
                <div className="flex gap-4 flex-wrap justify-between desktop:flex-nowrap">
                    ...
                    <div className="order-1 w-full desktop:order-2 desktop:flex-none desktop:w-auto">
                        {/* Tabs */}
                        <ul className="flex text-center text-secondary bg-surface-soft rounded-2xl items-center justify-around">
                            <li className="me-2 w-full">
                                <a href="#" className="inline-block px-4 py-3 rounded-lg active w-full" aria-current="page">NFTs</a>
                            </li>
                            <li className="me-2 w-full">
                                <a href="#"  className="inline-block px-4 py-2.5 bg-tab rounded-xl w-full" style={{boxShadow: '0px 8px 20px 0px rgba(0, 0, 0, 0.02), 0px 1px 4px 0px rgba(0, 0, 0, 0.12)'}}>Collection</a>
                            </li>
                            <li className="me-2 w-full">
                                <a href="#" className="inline-block px-3 py-3 rounded-lg hover:bg-gray-100 w-full">Users</a>
                            </li>
                        </ul>
                    </div>
                    <div className="relative flex-1 order-2 desktop:order-3">
                        <Input appendIcon={<CommandIcon color="gray-500" width={14} height={14}/>} appendIconContainerClass="w-6 h-6 bg-surface-medium rounded-lg top-1/4 right-4 py-0 pr-0 pl-1.5"/>
                    </div>
                    <div className="order-4">
                        <Button variant="secondary">Trending <span className="p-1 bg-surface-medium rounded-lg"><ChevronDownIcon color="gray-500" width={14} height={14}/></span></Button>
                    </div>
                </div>
            </div>
