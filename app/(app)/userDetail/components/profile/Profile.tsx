...
import MoreIcon from "@/assets/svg/more-vertical";
import EditProfile from "@/app/(app)/userDetail/components/button/EditProfile";
        ...
        <div className="">
            <div className="flex">
                <div className="w-full relative">
                    ...
                    <div className="absolute border-white rounded-2xl pl-[80px]" style={{ bottom: '0', transform: 'translateY(50%)' }}>
