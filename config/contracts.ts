...
export const contracts: Record<string, Contract> = {
  ...
  erc1155Proxy: { address: '0xc2587c1b945b1a7be4be5423c24f1bbf54495daa', abi: erc1155ABI },
  erc1155: { address: '0x4b1AAC431446D84e238784F8Ad4e31712A7Aeb1B', abi: erc1155ABI },
