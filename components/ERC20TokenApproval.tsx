...
export default function ERC20TokenApproval({
    ...
    return (
        <div className="w-full flex flex-col gap-2">
            ...
            <div className="flex items-center gap-2">
                <Button variant="secondary" onClick={onApproveMinAmount} className="!min-w-fit p-3">Min</Button>
                <Input
            ...
            <Button loading={loading} onClick={onApproveToken} className="w-full">Approve Token contract</Button>
        </div>
    )
}