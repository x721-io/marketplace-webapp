        ...
        return (
              ...
              >
                ...
                <Text className="font-semibold">
                  {collection.floorPrice}{" "} U2U
                </Text>
              </Link>
        );
      })}
      <Link  onClick={onClose} href={`/explore/collections`} className=" border border-tertiary rounded-xl mt-1 py-1 bg-gray-100">
        <div className="flex gap-1 items-center justify-center">
          <Icon name="search" width={22} height={22}/>
          <Text className="font-semibold text-primary" variant="body-14">See all Collections</Text>
        </div>
      </Link>
    </div>
  );
