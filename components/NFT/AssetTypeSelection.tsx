    ...
    <div className="w-full flex flex-col items-center gap-6 justify-center py-10 tablet:py-20 desktop:py-20">
      ...
      <div className="flex gap-4 tablet:w-[550px] w-full px-4">
        ...
        >
          ...
          <Text className="desktop:text-heading-sm tablet:text-heading-sm text-body-24 font-bold text-primary text-center">
            Single Item
          </Text>
          <Text className="text-body-12 font-bold text-secondary text-center">
