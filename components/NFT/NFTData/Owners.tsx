...
export default function OwnersTab({
  ...
  return (
      <div className="w-full py-7">
        <div
            className="w-full p-3 desktop:p-5 tablet:p-4  flex flex-col desktop:gap-4 tablet:gap-4 gap-3 rounded-2xl border">
                    ...
                    >
                      ...
                      <ConnectWalletButton showConnectButton>
                        {owner.publicKey.toLowerCase() === userWallet?.toLowerCase() ? (
                            <div
                                className="text-body-14 font-medium text-secondary p-2 rounded-lg bg-surface-soft w-[90px] tablet:w-[120px] desktop:w-[120px] text-center">
                              This is me
                            </div>
                        ) : !!owner.sellInfo ? (
                            <Button
