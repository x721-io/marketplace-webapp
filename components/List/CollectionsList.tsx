...
export default function CollectionsList({
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (scrollTop + clientHeight === scrollHeight && !loading && paging && onLoadMore && currentHasNext) {
        onLoadMore(paging + 1);
      }
    };
        ...
        >
          {showCreateCollection
              ...
              <Link href={`/create/collection`}>
                <div
                    className="flex items-center justify-center rounded-xl hover:shadow-md transition-all h-[192px] border">
                            ...
                            <div className="flex gap-2 flex-col">
                              <div className="flex gap-1 items-center">
                                <Tooltip content={c.name} placement="bottom">
                                  <Text
                                      className="font-medium text-ellipsis whitespace-nowrap text-gray-900 max-w-[100px] overflow-hidden break-words">
                                    {c.name}
                                  </Text>
                                </Tooltip>
