          ...
          <div className="flex flex-col gap-6">
            ...
            </div>
            {
              myId === user.id ?
                ...
                ) : <UserFollow onRefresh={onRefresh} userId={user.id} isFollowed={user.isFollowed} />
            }
            <div className="flex items-center gap-3">
              ...
              <div className="flex gap-2">
                <Text className="text-body-12 font-medium">{formatDisplayedNumber(user.following, 1)}</Text>
